    ...
    function L() {
        ...
        $(document).bind("touchstart", function(ad) {
            ...
            if (O(ad.target) && !H) {
                ...
                var delay;
                try {
                    delay = parseInt($("input[name='flag_speed']:checked").val());
                } catch (e) {
                    delay = 500;
                }
                setTimeout(function() {
                ...
                if (O(ae.target) && !H) {
                    ...
                    if (t) {
                      console.log("D");
                        ...
                        if (!z) {
                            if (!h) { // CLICK NOT Mine FIRST CLICK
                                ac = r(ad);
                                console.log("A");
                            }
                            if (!ad.reveal1()) { // CLICKED MINE
                              console.log("B");
                                M([ad])
                            }
                            if (!h) {
